...
- [ ] استپ ۲۰ — داشبورد واحد «کنترل‌مرکز»: نمودار زنده‌ی آپلود/دانلود، مصرف کل، استراتژی فعالِ زنده، وضعیت resilience، حالت tunnel/proxy (بازخورد ۸ و ۵b و ۷)
- [ ] استپ ۲۱ — پروکسی سیستم ویندوز (set/unset رجیستری) + سوییچ در UI «تونل/پروکسی سیستم» (بازخورد ۷)
- [ ] استپ ۲۲ — لاگ حرفه‌ای: timestamp، سطح‌بندی info/ok/warn/err با رنگ، فیلتر، شمارنده (بازخورد ۱)
- [ ] استپ ۲۳ — صفحه‌ی استراتژی کلیک‌پذیر + بازطراحی تم سه‌بعدی/مدرن (کارت‌های معلق/شیشه/سایه عمیق/هاور) + رفع drag پنجره (بازخورد ۴/۵/۶)
