...
- نظافتِ پس از roadmap: آرشیو/حذفِ UIِ قدیمیِ tkinter (`gui.py`, `gui_old2.py`) و یک build واقعی روی ویندوز
  برای تأییدِ نهاییِ exe (sandbox فقط import/preflight را تست می‌کند).
